  ...
  return (
    <div className={"w-full h-screen bg-gray-50"}>
      <div className={"h-full w-full flex justify-center items-center"}>
        <div
          className={
            "bg-white w-full md:w-4/6 h-4/6 md:h-auto m-3 shadow-md flex"
          }
        >
          {/* image part */}
          ...
          >
            <div className={"text-3xl"}>Login to start</div>
            ...
            <div className={"mt-3"}>
              <input
                ...
                className={
                  "w-full border-b-2 border-gray-400 px-x py-2 outline-none focus:border-gray-700"
                }
              />
              <input
                type="password"
